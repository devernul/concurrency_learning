package ua.kruart.chapter08_customizing_concurrency_classes.recipe09_impl_priority_TransferQueue.task;
...
public class MyPriorityTransferQueue<E> extends PriorityBlockingQueue<E> implements TransferQueue<E> {
    ...
    /**
     * Blocking queue to store the transferred elements
     */
     ...
     * in the transferred queue and returns the false value. In this case, the
     ...
     * queue. Else, puts the element in the queue of transferred elements and
     ...
     * queue is empty. If there is transferred elements, takes the first
     * transferred element and wake up the thread that is waiting for the
